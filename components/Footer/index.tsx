        ...
        >
            <div className={styles['footer__inner']}>
                ...
                <div className={clsx([styles['footer__section'], styles['footer__links']])}>
                    ...
                    <Link className={styles['footer__section-link']} href="https://tempus-ex.com/">
                        Tempus Ex Home
                    </Link>
                    <Link className={styles['footer__section-link']} href="https://tempus-ex.com/careers">
                        Careers
                    </Link>
                </div>
                <div className={clsx([styles['footer__section'], styles['footer__contact']])}>
                    ...
                    <Link className={styles['footer__section-email']} href="mailto:support@tempus-ex.com">
                    ...
                    <div className={styles['footer__section-social']}>
                        <Link
                            ...
                            target="blank"
                        >
                            <Image src={github} width={24} height={24} alt={'GitHub organization'} />
                        </Link>
                        ...
                        <Link
                            ...
                            target="blank"
                        >
                            <Image src={twitter} width={24} height={24} alt={'Tempus Ex official Twitter account'} />
                        </Link>
                    </div>
                </div>
            </div>
