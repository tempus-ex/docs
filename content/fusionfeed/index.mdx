...
All API endpoints are prefixed with a major version number. The current major API version is V2. Thus all of the current APIs are prefixed with <code>{config.fusionFeedUrl}/v2/</code>.
