...
Use the GET /games, GET /teams and GET /players to get a full list of game IDs, team and player information. The game IDs can then be used to retrieve play information or AV stream IDs for transcoding video angles.
